...
function ModalTrivia() {
    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center z-50 bg-gray-900 bg-opacity-95 mt-6 mb-2 border">
        <div className="bg-gray-300 m-4 p-6  border-red-500 rounded-xl ">
            <h3 className="text-center font-extrabold text-xl mb-4 ">Trivia Manual del buen Conductor</h3>
            <p className="mb-4 font-bold">{data[indiceActivo]?.pregunta}</p>
            ...
            <div className="mt-4 text-center">
                ...
                <span className="text-red-600">Respuesta incorrecta! La correcta era: {data[indiceActivo]?.true}</span>
                )}
            </div>
            )}
        </div>
